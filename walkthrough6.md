...
### 6. Integración del Backoffice (Secciones y Productos)
Para comenzar a darle vida funcional al panel de administrador, se implementó el CRUD completo para las categorías/secciones y los productos:
1. **API ([src/services/mock/catalog.ts](file:///c:/Users/Juan%20Cruz%20IT%20Oeste/OneDrive/Desktop/jc/react/tiniMigliore/src/services/mock/catalog.ts))**: Se actualizaron y programaron los métodos de mutación (create/delete/update).
2. **UI Interfaz ([src/features/admin/pages/AdminSectionsPage.tsx](file:///c:/Users/Juan%20Cruz%20IT%20Oeste/OneDrive/Desktop/jc/react/tiniMigliore/src/features/admin/pages/AdminSectionsPage.tsx) y [AdminProductsPage.tsx](file:///c:/Users/Juan%20Cruz%20IT%20Oeste/OneDrive/Desktop/jc/react/tiniMigliore/src/features/admin/pages/AdminProductsPage.tsx))**:
   - Reutilizamos componentes existentes ([Modal](file:///c:/Users/Juan%20Cruz%20IT%20Oeste/OneDrive/Desktop/jc/react/tiniMigliore/src/components/ui/Modal.tsx#17-102) e [Input](file:///c:/Users/Juan%20Cruz%20IT%20Oeste/OneDrive/Desktop/jc/react/tiniMigliore/src/components/ui/Input.tsx#5-9)) del Design System actual.
   - En Productos agregamos la capacidad de asociar una sección al mismo mediante un "Select" dinámico y también soporte de preview de imagen mediante URL.
   - Centralizamos la lógica: un solo formulario maneja tanto la **Creación** como la **Edición**.
