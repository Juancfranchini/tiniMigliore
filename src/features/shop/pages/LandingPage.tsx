...
import contactoFallback from '../../../assets/contacto.png';
import logoCircular from '../../../assets/icon.png';
...
export default function LandingPage() {
  ...
  const heroImg = settings?.landing?.heroImageUrl || '/hero-torta.jpg';
  const aboutImg = settings?.landing?.aboutImageUrl || contactoFallback;
  ...
  return (
    <div className={`${styles.page} ${isDark ? styles.dark : ''}`}>
      ...
      <section className={styles.hero}>
        ...
        {/* Textos verticales — izquierda y derecha */}
        <span className={styles.heroVerticalTextLeft}>Hecho con amor</span>
        <span className={styles.heroVerticalTextRight}>Pastelería Artesanal</span>
      ...
      <section id="sobre-tini" className={styles.about}>
        ...
        <div className={styles.aboutGrid}>
          ...
          <div className={styles.aboutImageWrap}>
            <img src={aboutImg} alt="Tini Migliore en su pastelería" className={styles.aboutImage} loading="lazy" />
          </div>
        </div>
      </section>
      ...
      <section className={styles.contact} id="contacto">
        <div className={styles.contactInner}>
          ...
          <div className={styles.contactBrand}>
            <img src={logoCircular} alt="Tini Migliore" className={styles.contactLogoImg} />
            <div className={styles.contactBrandText}>
              <span className={styles.contactBrandName}>TINI MIGLIORE</span>
              <span className={styles.contactBrandSub}>— PASTELERÍA —</span>
              <span className={styles.contactBrandTagline}>Pastelería artesanal con alma</span>
            </div>
          </div>
          ...
          <div className={styles.contactLinks}>
            <span className={styles.contactEyebrow}>Encontrame en</span>
            <div className={styles.socialRow}>
              ...
              <a href={contactSettings?.tiktokUrl || 'https://www.tiktok.com/@tini.migliore'} target="_blank" rel="noopener noreferrer" className={styles.socialItem}>
                <PlaySquare size={16} /><span>TikTok</span>
              </a>
            </div>
          </div>
